...
@pytest.mark.parametrize('test_input, expected', [
    ('2016/10/20',
        (date(2016, 10, 20), '', UNSPECIFIED_PAYEE, False)),
    ('2016/10/20 someone',
        (date(2016, 10, 20), '', 'someone', False)),
    ('2016/10/20     someone',
        (date(2016, 10, 20), '', 'someone', False)),
    ('2016/10/20 someone     ; comment',
        (date(2016, 10, 20), '', 'someone', False)),
    ('2016/02/04 (123)',
        (date(2016, 2, 4), '123', UNSPECIFIED_PAYEE, False)),
    ('2016/02/04      (123)',
        (date(2016, 2, 4), '123', UNSPECIFIED_PAYEE, False)),
    ('2016/02/04 (123) someone',
        (date(2016, 2, 4), '123', 'someone', False)),
    ('2016/02/04    (123)     someone',
        (date(2016, 2, 4), '123', 'someone', False)),
    ('2016/02/04 (123)someone',
        (date(2016, 2, 4), '123', 'someone', False)),
    ('2001/04/11 (abc)           ; yah',
        (date(2001, 4, 11), 'abc', '; yah', False)),
    ('2001/04/11 (abc)     ; fu    ; bar',
        (date(2001, 4, 11), 'abc', '; fu', False)),
    ('2001/04/11 (abc) some1     ; c',
        (date(2001, 4, 11), 'abc', 'some1', False)),
    ('2001/04/11 () someone        ; yah',
        (date(2001, 4, 11), '', 'someone', False)),
    ('2018/07/07 name w/ spaces',
        (date(2018, 7, 7), '', 'name w/ spaces', False)),
    ('2018/07/07 payee name with spaces  ; and comment',
        (date(2018, 7, 7), '', 'payee name with spaces', False)),
    ('2018/07/07 payee name ; includes semicolon',
        (date(2018, 7, 7), '', 'payee name ; includes semicolon', False)),
    ('2001/04/11(abc)',
        (None, '', None, False)),
    ('2001/04/11someone',
        (None, '', None, False)),
    ('2018/07/07 * someone',
        (date(2018, 7, 7), '', 'someone', True)),
    ('2018/07/07 ! someone',
        (date(2018, 7, 7), '', 'someone', True)),
    ('2018/07/07 *someone',
        (date(2018, 7, 7), '', 'someone', True)),
    ('2018/07/07 !someone',
        (date(2018, 7, 7), '', 'someone', True)),
    ('2018/07/07 * (123) someone',
        (date(2018, 7, 7), '123', 'someone', True)),
    ('2018/07/07 ! (123) someone',
        (date(2018, 7, 7), '123', 'someone', True)),
    ('2018/07/07 *(123) someone',
        (date(2018, 7, 7), '123', 'someone', True)),
